...
label = CTkLabel(main_wind, text="Полное имя", fg_color="transparent", text_color=("#ffff00", "#DCE4EE"))
label.pack()
entry = CTkEntry(main_wind, width=500, placeholder_text="Иванов Иван Иванович")
entry.pack()
...
butt_submit = CTkButton(main_wind, text="Submit", command=button_event, hover = True)
butt_submit.pack()
